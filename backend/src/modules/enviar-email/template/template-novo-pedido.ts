...
export const templateNovoPedido = (
    ...
    <tr style="width:100%">
      ...
      <img alt="Linear" src="https://i.ibb.co/KLvf9xD/logo.jpg" width="220" height="220" style="display:block;outline:none;     border:none;text-decoration:none;border-radius:21px;width:42px;height:42px" />
        ...
        <p style="font-size:15px;line-height:1.4;margin:0 0 15px;color:#3c4149">Faça login com seu E-mail em: 
          <a target="_blank" style="font-size:14px" href="${process.env.URL_FRONT}/pedido/${pedido_id}">
          KMB Rodízios
          </a>
          <br>
        ...
        <hr style="width:100%;border:none;border-top:1px solid #eaeaea;border-color:#dfe1e4;margin:42px 0 26px" /><a target="_blank" style="color:#b4becc;text-decoration:none;font-size:14px" href="${process.env.LINK_LOGIN}">KMB Rodízios</a>
      </td>
    </tr>
  </table>
</body>
